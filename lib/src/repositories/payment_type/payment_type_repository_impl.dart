...
class PaymentTypeRepositoryImpl implements PaymentTypeRepository {
  ...
  Future<List<PaymentTypeModel>> findAll(bool? enabled) async {
    try {
      ...
      throw RepositoryException(message: 'Erro ao bucar formas de pagemtno');
    }
  }
  ...
  Future<PaymentTypeModel> getById(int id) async {
    try {
      ...
      log('Erro Ao buscar forma de pagamento de codigo ($id)',
          error: e, stackTrace: s);
      throw RepositoryException(
        message: 'Erro Ao buscar forma de pagamento de codigo ($id)',
      );
    }
  }
